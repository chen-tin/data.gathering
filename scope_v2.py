    ...
    if device_data.name != "Digital Discovery":
        ...
        for i in range(1):  # 
            ...
            try:
                ...
                time = [index * 1e06 / sampling_frequency for index in range(len(buffer))]  # Convert time vector to microsecond

                # Define zoom length
                zoom_length = 2  # Length of zoom in microsecond
                ...
                filename = fr'\sample_{i+1}_trig_{trig}.txt'
